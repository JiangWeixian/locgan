...
class COCOVoc(data.Dataset):
    ...
    def __init__(self,
        ...
        self.mask_transform = mask_transform
        self.target_transform = COCOTargetTransform(mask_transform)
    ...
    def __getitem__(self, index):
        ...
        if self.target_transform is not None:
            target = self.target_transform(img, annos)
        ...
        return img, mask, target, anno, wh
    ...
    def _get_bbox(self, imgId):
        ...
        for ele in anns:
            ...
            if masks == None:
                masks = self.coco.annToMask(ele)*gap
            else:
                masks += self.coco.annToMask(ele)*gap
