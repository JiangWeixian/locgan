...
from data.seg import VOCDetection, AnnotationTransform, Combine
...
datasets = VOCDetection(source_transform=source_transformer, anno_transform=AnnotationTransform(), mask_transform=Combine(size=321))
