...
class DetectModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.netD = define_netD('fm2', grah_netD['fm'], 3)
    ...
    def backward_G(self):
        ...
        _, self.fake_conf, self.fake_loc = self.netG.forward(self.fake_target)
        ...
        # Loss D
        self.loss_G = self.loss_G_GAN +  (self.loss_fm + self.loss_l1) +(self.fake_loss_l + self.fake_loss_c)
    ...
    def save_location(self):
        ...
        log.info("The detection result in GD: {}".format(output))
    ...
    def current_errors(self):
        ...
        return {'loss': (self.fake_loss_c + self.fake_loss_c).data[0]}        
