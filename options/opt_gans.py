...
parser.add_argument('--save_epoch_freq', default=2, help='frequency for saving results')
parser.add_argument('--log_iters_freq', default=100, help='frequency for log errors')
parser.add_argument('--g_network_path', default='/home/eric/Documents/PY35/locgan/checkpoints/mask/epoch_10_train_mask_netG.pth')
parser.add_argument('--d_network_path', default='/home/eric/Documents/PY35/locgan/checkpoints/mask/epoch_10_train_mask_netD.pth')
