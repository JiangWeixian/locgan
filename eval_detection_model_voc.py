...
parser.add_argument('--trained_model', default='/media/eric/GANS/epoch_259_TRAIN_DETECT_netG_.pth',
...
def test_net(save_folder, net, cuda, dataset, top_k,
    ...
    for i in range(num_images):
        im, mask, gt, wh = dataset.pull_item(i)
        w, h = wh
...
if __name__ == '__main__':
    ...
    datasets = VOCDetection(root=args.voc_root, image_sets=[('2007', 'test')], transform=BaseAugmentation(321), target_transform=AnnotationTransform(), mask_transform=MaskTransform())            
